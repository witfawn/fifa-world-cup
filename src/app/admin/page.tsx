      ...
      <main className="max-w-2xl mx-auto px-4 py-6 pb-24">
        ...
        >
          <button
            ...
            style={{
              backgroundColor: activeTab === 'scoring' ? 'var(--gold)' : 'transparent',
              color: activeTab === 'scoring' ? '#000' : 'var(--muted)',
            }}
          >
            ⚽ Scoring
          </button>
          <button
            ...
            className="flex-1 py-2.5 rounded-lg text-sm font-bold transition-all"
            style={{
              backgroundColor: activeTab === 'payments' ? 'var(--gold)' : 'transparent',
              color: activeTab === 'payments' ? '#000' : 'var(--muted)',
            }}
          >
            💰 Payments
          </button>
